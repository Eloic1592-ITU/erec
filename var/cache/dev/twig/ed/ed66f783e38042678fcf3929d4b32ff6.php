...
class __TwigTemplate_1e67294c4d175c204288104f4ccbb32c extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
                ...
                // line 18
                echo "        ";
                echo twig_include($this->env, $context, "@WebProfiler/Profiler/table.html.twig", ["data" => twig_get_attribute($this->env, $this->source, ($context["request"] ?? null), "routeParams", [], "any", false, false, false, 18), "labels" => ["Name", "Value"]], false);
                echo "
    ";
            }
        }
...
";
    ...
    {
        return new Source("", "@WebProfiler/Router/panel.html.twig", "D:\\PROJECTS\\Php\\erecrutement\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Router\\panel.html.twig");
    }
}

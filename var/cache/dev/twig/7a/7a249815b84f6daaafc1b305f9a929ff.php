...
class __TwigTemplate_1975a1150f11f099e8622cb4788022b2 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "back/candidate/index.html.twig"));
            ...
            series: [
                {
                    ...
                    data: ";
        // line 115
        echo json_encode(twig_array_map($this->env, (isset($context["studyFieldStats"]) || array_key_exists("studyFieldStats", $context) ? $context["studyFieldStats"] : (function () { throw new RuntimeError('Variable "studyFieldStats" does not exist.', 115, $this->source); })()), function ($__v__) use ($context, $macros) { $context["v"] = $__v__; return ["name" => twig_get_attribute($this->env, $this->source, (isset($context["v"]) || array_key_exists("v", $context) ? $context["v"] : (function () { throw new RuntimeError('Variable "v" does not exist.', 115, $this->source); })()), "name", [], "any", false, false, false, 115), "value" => twig_get_attribute($this->env, $this->source, (isset($context["v"]) || array_key_exists("v", $context) ? $context["v"] : (function () { throw new RuntimeError('Variable "v" does not exist.', 115, $this->source); })()), "candidate_count", [], "any", false, false, false, 115)]; }));
        echo ",
                    emphasis: {
                        itemStyle: {
                            shadowBlur: 10,
            ...
            series: [
                {
                    ...
                    data: ";
        // line 139
        echo json_encode(twig_array_map($this->env, (isset($context["degreeStats"]) || array_key_exists("degreeStats", $context) ? $context["degreeStats"] : (function () { throw new RuntimeError('Variable "degreeStats" does not exist.', 139, $this->source); })()), function ($__v__) use ($context, $macros) { $context["v"] = $__v__; return ["name" => twig_get_attribute($this->env, $this->source, (isset($context["v"]) || array_key_exists("v", $context) ? $context["v"] : (function () { throw new RuntimeError('Variable "v" does not exist.', 139, $this->source); })()), "name", [], "any", false, false, false, 139), "value" => twig_get_attribute($this->env, $this->source, (isset($context["v"]) || array_key_exists("v", $context) ? $context["v"] : (function () { throw new RuntimeError('Variable "v" does not exist.', 139, $this->source); })()), "candidate_count", [], "any", false, false, false, 139)]; }));
        echo ",
                    emphasis: {
                        itemStyle: {
                            shadowBlur: 10,
            ...
            series: [
                {
                    ...
                    data: ";
        // line 163
        echo json_encode(twig_array_map($this->env, (isset($context["positionStats"]) || array_key_exists("positionStats", $context) ? $context["positionStats"] : (function () { throw new RuntimeError('Variable "positionStats" does not exist.', 163, $this->source); })()), function ($__v__) use ($context, $macros) { $context["v"] = $__v__; return ["name" => twig_get_attribute($this->env, $this->source, (isset($context["v"]) || array_key_exists("v", $context) ? $context["v"] : (function () { throw new RuntimeError('Variable "v" does not exist.', 163, $this->source); })()), "name", [], "any", false, false, false, 163), "value" => twig_get_attribute($this->env, $this->source, (isset($context["v"]) || array_key_exists("v", $context) ? $context["v"] : (function () { throw new RuntimeError('Variable "v" does not exist.', 163, $this->source); })()), "candidate_count", [], "any", false, false, false, 163)]; }));
        echo ",
                    emphasis: {
                        itemStyle: {
                            shadowBlur: 10,
...
";
    ...
    {
        return array (  292 => 163,  265 => 139,  238 => 115,  224 => 103,  214 => 102,  173 => 69,  118 => 17,  115 => 16,  105 => 15,  92 => 11,  82 => 10,  71 => 6,  61 => 5,  38 => 2,);
    }
        ...
        <div class=\"row\">
            <div class=\"col-lg-12\">
                <div class=\"card\">
                    ...
                    <div class=\"card-body p-0\">
                        {{ include('back/partials/tables/candidate/_index.html.twig') }}
                    </div>
                </div>
            </div>
        </div>
            ...
            series: [
                {
                    ...
                    type: 'pie',
                    radius: '50%',
                    data: {{ studyFieldStats|map(v => { name: v.name, value: v.candidate_count })|json_encode|raw }},
                    emphasis: {
                        itemStyle: {
                            shadowBlur: 10,
                            shadowOffsetX: 0,
            ...
            series: [
                {
                    ...
                    type: 'pie',
                    radius: '50%',
                    data: {{ degreeStats|map(v => { name: v.name, value: v.candidate_count })|json_encode|raw }},
                    emphasis: {
                        itemStyle: {
                            shadowBlur: 10,
                            shadowOffsetX: 0,
            ...
            series: [
                {
                    ...
                    type: 'pie',
                    radius: '50%',
                    data: {{ positionStats|map(v => { name: v.name, value: v.candidate_count })|json_encode|raw }},
                    emphasis: {
                        itemStyle: {
                            shadowBlur: 10,
                            shadowOffsetX: 0,
...
", "back/candidate/index.html.twig", "D:\\PROJECTS\\Php\\erecrutement\\templates\\back\\candidate\\index.html.twig");
    }
}

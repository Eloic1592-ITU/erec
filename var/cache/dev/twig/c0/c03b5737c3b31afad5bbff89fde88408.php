...
class __TwigTemplate_a892733b763e26a13f2cb01096360482 extends Template
{
    private $source;
    private $macros = [];
    ...
    <tbody>
        ...
        $context['_seq'] = twig_ensure_traversable(twig_sort_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["bag"] ?? null), "keys", [], "any", false, false, false, 9)));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["key"]) {
            ...
            echo "</th>
                <td>";
            // line 12
            echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension']->dumpData($this->env, twig_get_attribute($this->env, $this->source, ($context["bag"] ?? null), "get", [$context["key"]], "method", false, false, false, 12), ((array_key_exists("maxDepth", $context)) ? (_twig_default_filter(($context["maxDepth"] ?? null), 0)) : (0)));
            echo "</td>
            </tr>
        ";
...
";
    ...
    {
        return new Source("", "@WebProfiler/Profiler/bag.html.twig", "D:\\PROJECTS\\Php\\erecrutement\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Profiler\\bag.html.twig");
    }
}

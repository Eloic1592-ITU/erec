...
class __TwigTemplate_d6be65d6079acf0006ad5ac7144b201b extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
      <div class=\"col-lg-12\">
        <div class=\"d-block w-100\">
          ";
        // line 197
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["otherInfoForm"]) || array_key_exists("otherInfoForm", $context) ? $context["otherInfoForm"] : (function () { throw new RuntimeError('Variable "otherInfoForm" does not exist.', 197, $this->source); })()), "otherNotInfoSkills", [], "any", false, false, false, 197), 'widget');
        echo "
        </div>
      </div>
    </div>
    ...
    <div class=\"mt-4 pt-4 d-flex justify-content-between\">
      ...
      <div id=\"other-info-actions\" class=\"d-flex gap-2\">
        ...
        <button 
          ...
          ";
        // line 218
        if (twig_test_empty((isset($context["is_other_info_edit"]) || array_key_exists("is_other_info_edit", $context) ? $context["is_other_info_edit"] : (function () { throw new RuntimeError('Variable "is_other_info_edit" does not exist.', 218, $this->source); })()))) {
            echo " 
            disabled 
          ";
        }
...
";
        // line 232
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["otherInfoForm"]) || array_key_exists("otherInfoForm", $context) ? $context["otherInfoForm"] : (function () { throw new RuntimeError('Variable "otherInfoForm" does not exist.', 232, $this->source); })()), 'form_end');
...
{{ form_start(otherInfoForm, {
  ...
  <div class=\"step step-7\">
    ...
    <div class=\"row\">
      <div class=\"col-lg-12\">
        <div class=\"d-block w-100\">
          {{ form_widget(otherInfoForm.otherNotInfoSkills) }}
        </div>
      </div>
    </div>
...
{{ form_end(otherInfoForm) }}", "front/partials/steps/_step7.html.twig", "/var/www/html/erecrutement/templates/front/partials/steps/_step7.html.twig");
    }
}

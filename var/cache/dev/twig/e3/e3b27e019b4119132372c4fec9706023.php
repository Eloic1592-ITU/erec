...
class __TwigTemplate_fe035142dbd2ec023f1742ba9ece9c1c extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "back/partials/tables/field-of-study/_index.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "back/partials/tables/field-of-study/_index.html.twig"));
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["allfieldOfStudy"]) || array_key_exists("allfieldOfStudy", $context) ? $context["allfieldOfStudy"] : (function () { throw new RuntimeError('Variable "allfieldOfStudy" does not exist.', 12, $this->source); })()));
...
";
        // line 64
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["fieldOfStudyForms"]) || array_key_exists("fieldOfStudyForms", $context) ? $context["fieldOfStudyForms"] : (function () { throw new RuntimeError('Variable "fieldOfStudyForms" does not exist.', 64, $this->source); })()));
        $context['loop'] = [
...
";
    ...
    {
        return array (  165 => 65,  148 => 64,  143 => 61,  138 => 57,  127 => 51,  119 => 46,  114 => 43,  106 => 38,  101 => 35,  99 => 34,  90 => 28,  82 => 22,  78 => 20,  74 => 18,  72 => 17,  67 => 15,  63 => 14,  60 => 13,  56 => 12,  43 => 1,);
    }
    ...
    <tbody>
    {% for fieldOfStudy in allfieldOfStudy %}
        <tr>
            <td>{{ fieldOfStudy.getId() }}</td>
            <td>{{ fieldOfStudy.getName() }}</td>
            <td>
                {% if not fieldOfStudy.isDeleted() %}
            ...
            <td>
                <div class=\"d-flex justify-content-end gap-1\">
                    <button 
                        class=\"btn-action bg-warning\" 
                        data-bs-toggle=\"modal\" 
                        data-bs-target=\"#field-of-study-{{ fieldOfStudy.getId() }}\"
                    >
                        <i class=\"bx bx-edit\"></i> 
                        <span>Modifier</span>
                    </button>
                    ...
                    {% if not fieldOfStudy.isDeleted() %}
                        <button 
                            class=\"btn-action btn-state bg-danger delete-field-of-study\"
                            data-state=\"désactiver ce domaine d'études\" 
                            data-url=\"{{ path('admin_field_of_study_disable', {'id': fieldOfStudy.getId()}) }}\"
                        >
                            <span>Désactiver</span>
                        </button>
                    {% else %}
                        <button 
                            class=\"btn-action btn-state bg-success delete-field-of-study\"
                            data-state=\"réactiver ce domaine d'études\" 
                            data-url=\"{{ path('admin_field_of_study_activate', {'id': fieldOfStudy.getId()}) }}\"
                        >
                            <span>Activer</span>
                        </button>
                    {% endif %}
...
{{ include('back/partials/modals/_newFieldOfStudy.html.twig') }}

{# Modals for Editing each items #}
{% for fieldOfStudyForm in fieldOfStudyForms %}
    {{ include('back/partials/modals/_editFieldOfStudy.html.twig') }}
{% endfor %}", "back/partials/tables/field-of-study/_index.html.twig", "D:\\PROJECTS\\Php\\erecrutement\\templates\\back\\partials\\tables\\field-of-study\\_index.html.twig");
    }
}

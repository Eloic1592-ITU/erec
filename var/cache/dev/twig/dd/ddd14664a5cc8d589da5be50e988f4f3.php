...
class __TwigTemplate_cb705a780ab4990185201ca2ae6fb96e extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"container\">
    ...
    <div class=\"d-none d-lg-block\">
      <ul class=\"navbar-nav ms-auto\">
        ...
        // line 54
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_user_edit_profile", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 54), "id", [], "any", false, false, false, 54)]), "html", null, true);
        echo "\">
            ...
            <li>
              <a class=\"dropdown-item d-flex align-items-center gap-2\" href=\"";
        // line 59
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_user_edit_password", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 59), "id", [], "any", false, false, false, 59)]), "html", null, true);
        echo "\">
    ...
    >
      ...
      <div class=\"offcanvas-body\">
        ...
        // line 97
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_user_edit_profile", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 97), "id", [], "any", false, false, false, 97)]), "html", null, true);
        echo "\">
              <div class=\"pic d-flex ms-0\"><i class=\"fas fa-user text-white\"></i></div>
              ";
        // line 99
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 99), "getFirstName", [], "method", false, false, false, 99), "html", null, true);
        echo "
            </a>
          </li>
        ...
        $context['_seq'] = twig_ensure_traversable(($context["navbarMenus"] ?? null));
        $context['loop'] = [
...
";
    ...
    {
        return array (  220 => 121,  206 => 120,  196 => 116,  192 => 115,  188 => 114,  185 => 113,  181 => 112,  172 => 111,  155 => 110,  146 => 104,  138 => 99,  133 => 97,  114 => 81,  94 => 64,  86 => 59,  78 => 54,  53 => 32,  49 => 31,  44 => 28,  42 => 4,  41 => 3,  40 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "back/partials/_navbar.html.twig", "D:\\PROJECTS\\Php\\erecrutement\\templates\\back\\partials\\_navbar.html.twig");
    }
}

...
class App_KernelProdContainer extends Container
{
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.response', [#[\Closure(name: 'App\\EventSubscriber\\RequestSubscribe')] fn () => ($container->privates['App\\EventSubscriber\\RequestSubscribe'] ?? self::getRequestSubscribeService($container)), 'onKernelResponse'], 0);
        $instance->addListener('kernel.controller', [#[\Closure(name: 'App\\EventSubscriber\\RequestSubscribe')] fn () => ($container->privates['App\\EventSubscriber\\RequestSubscribe'] ?? self::getRequestSubscribeService($container)), 'onKernelController'], 0);
    ...
    /*
     * Gets the private 'App\EventSubscriber\RequestSubscribe' shared autowired service.
     *
     * @return \App\EventSubscriber\RequestSubscribe
     */
    protected static function getRequestSubscribeService($container)
    {
        return $container->privates['App\\EventSubscriber\\RequestSubscribe'] = new \App\EventSubscriber\RequestSubscribe(($container->privates['security.csrf.token_generator'] ??= new \Symfony\Component\Security\Csrf\TokenGenerator\UriSafeTokenGenerator()), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)));
    }
    ...
    {
        return $container->privates['exception_listener'] = new \Symfony\Component\HttpKernel\EventListener\ErrorListener('App\\Controller\\ErrorController::show', ($container->privates['logger'] ?? self::getLoggerService($container)), false, []);
    }
    ...
    protected static function getSecurity_FirewallService($container)
    {
        ...
        $b->registerListener('main', 'app_logout', 'logout', '_csrf_token', NULL, NULL);

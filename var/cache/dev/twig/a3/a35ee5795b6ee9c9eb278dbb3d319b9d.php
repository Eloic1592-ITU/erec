...
class __TwigTemplate_6e1c01b7634bc1346c4d534c92ddc7d9 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"positions\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["position"]) {
            ...
            // line 20
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_landing", ["ref" => twig_get_attribute($this->env, $this->source, $context["position"], "getReference", [], "method", false, false, false, 20)]), "html", null, true);
            echo "\">
                    ";
            // line 21
    ...
    <div class=\"positions\">
        <div class=\"d-flex flex-column gap-2\">
            {% for position in positions %}  
                <a class=\"position\" href=\"{{ path('app_landing', { 'ref': position.getReference() }) }}\">
                    {{ position.getName() }}
                    <i class='bx bx-right-arrow-alt'></i>
                </a>   
            {% endfor %}    
...
{% block javascripts %}
    {# ... #}
{% endblock %}
", "front/position/index.html.twig", "D:\\PROJECTS\\Php\\erecrutement\\templates\\front\\position\\index.html.twig");
    }
}

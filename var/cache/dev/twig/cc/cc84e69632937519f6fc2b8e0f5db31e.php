...
class __TwigTemplate_7690eb0aedb150155b4e274f1aebb145 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "back/partials/tables/marital-status/_index.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "back/partials/tables/marital-status/_index.html.twig"));
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["allMaritalStatus"]) || array_key_exists("allMaritalStatus", $context) ? $context["allMaritalStatus"] : (function () { throw new RuntimeError('Variable "allMaritalStatus" does not exist.', 12, $this->source); })()));
...
";
        // line 63
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["maritalStatusForms"]) || array_key_exists("maritalStatusForms", $context) ? $context["maritalStatusForms"] : (function () { throw new RuntimeError('Variable "maritalStatusForms" does not exist.', 63, $this->source); })()));
        $context['loop'] = [
...
";
    ...
    <tbody>
    {% for maritalStatus in allMaritalStatus %}
        <tr>
            <td>{{ maritalStatus.getId() }}</td>
            <td>{{ maritalStatus.getName() }}</td>
            <td>
                {% if not maritalStatus.isDeleted() %}
            ...
            <td>
                <div class=\"d-flex justify-content-end gap-1\">
                    <button 
                        class=\"btn-action bg-warning\" 
                        data-bs-toggle=\"modal\" 
                        data-bs-target=\"#marital-status-{{ maritalStatus.getId() }}\"
                    >
                        <i class=\"bx bx-edit\"></i> 
                        <span>Modifier</span>
                    </button>
                    ...
                    {% if not maritalStatus.isDeleted() %}
                        <button 
                            class=\"btn-action btn-state bg-danger delete-marital-status\"
                            data-state=\"désactiver cette catégorie de situation familiale\" 
                            data-url=\"{{ path('admin_marital_status_disable', {'id': maritalStatus.getId()}) }}\"
                        >
                            <span>Désactiver</span>
                        </button>
                    {% else %}
                        <button 
                            class=\"btn-action btn-state bg-success delete-marital-status\"
                            data-state=\"réactiver cette catégorie de situation familiale\" 
                            data-url=\"{{ path('admin_marital_status_activate', {'id': maritalStatus.getId()}) }}\"
                        >
                            <span>Activer</span>
                        </button>
                    {% endif %}
...
{{ include('back/partials/modals/_newMaritalStatus.html.twig') }}

{# Modals for Editing each items #}
{% for maritalStatusForm in maritalStatusForms %}
    {{ include('back/partials/modals/_editMaritalStatus.html.twig') }}
{% endfor %}", "back/partials/tables/marital-status/_index.html.twig", "/var/www/html/erecrutement/templates/back/partials/tables/marital-status/_index.html.twig");
    }
}

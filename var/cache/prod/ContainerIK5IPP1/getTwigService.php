...
class getTwigService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $d->setDebug(false);
        $d->setTokenStorage(($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)));
        ...
        $instance->addExtension(new \App\Twig\NonceSecurityExtension($c));

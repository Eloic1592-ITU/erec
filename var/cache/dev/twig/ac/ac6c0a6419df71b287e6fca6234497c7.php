...
class __TwigTemplate_5a8a27287d90e00675b1420edea60bf5 extends Template
{
    private $source;
    private $macros = [];
  ...
  <body class=\"d-flex align-items-center justify-content-center\">
    <main class=\"d-flex justify-content-center items-center\">
      <div class=\"container\">
        ...
        <div class=\"row d-flex justify-content-center\">
          <div class=\"col-lg-4 border border-end border-2 border-white col-register\">
            <div class=\"d-flex flex-column text-center p-4\">
              ...
              ";
        // line 45
        if ((array_key_exists("refPosition", $context) && (isset($context["refPosition"]) || array_key_exists("refPosition", $context) ? $context["refPosition"] : (function () { throw new RuntimeError('Variable "refPosition" does not exist.', 45, $this->source); })()))) {
            // line 46
            echo "                <a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_registeration", ["ref" => (isset($context["refPosition"]) || array_key_exists("refPosition", $context) ? $context["refPosition"] : (function () { throw new RuntimeError('Variable "refPosition" does not exist.', 46, $this->source); })())]), "html", null, true);
        ...
        // line 66
        echo twig_escape_filter($this->env, (isset($context["last_username"]) || array_key_exists("last_username", $context) ? $context["last_username"] : (function () { throw new RuntimeError('Variable "last_username" does not exist.', 66, $this->source); })()), "html", null, true);
    ...
    ";
      ...
      document.addEventListener('DOMContentLoaded', (event) => {
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 126, $this->source); })()), "flashes", [], "any", false, false, false, 126));
        ...
        ";
        // line 136
        if ((isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 136, $this->source); })())) {
            // line 137
            echo "          showAlert(
            \"\",
...
";
    ...
    {
        return array (  290 => 143,  282 => 137,  280 => 136,  277 => 135,  271 => 134,  262 => 131,  258 => 130,  254 => 128,  249 => 127,  245 => 126,  241 => 124,  235 => 121,  229 => 118,  223 => 115,  219 => 112,  213 => 109,  207 => 106,  201 => 103,  179 => 83,  171 => 78,  156 => 66,  150 => 63,  147 => 62,  139 => 59,  136 => 58,  134 => 57,  125 => 50,  121 => 48,  115 => 46,  113 => 45,  83 => 18,  79 => 17,  75 => 16,  71 => 15,  67 => 14,  63 => 13,  59 => 12,  52 => 8,  43 => 1,);
    }
        ...
        <div class=\"row d-flex justify-content-center\">
          <div class=\"col-lg-4 border border-end border-2 border-white col-register\">
            <div class=\"d-flex flex-column text-center p-4\">
              ...
              {% if refPosition is defined and refPosition %}
                <a href=\"{{ path('app_registeration', { 'ref': refPosition })}}\" class=\"btn btn-lg btn-success w-100\">S'inscrire maintenant</a>
              {% else %}
                <button type=\"button\" class=\"btn btn-lg btn-success w-100\" data-bs-toggle=\"modal\" data-bs-target=\"#positionsModal\">S'inscrire maintenant</button>
              {% endif %}
            </div>
          </div>
          <div class=\"col-lg-4 border border-2 border-white col-login\">
            <div class=\"d-flex flex-column text-center p-4\">
              ...
              <form id=\"login-form\" method=\"post\" action=\"{{ path('app_login') }}\">
                <div class=\"input-group input-group-lg flex-nowrap mb-3\">
                  <span class=\"input-group-text\" id=\"emai\"><i class=\"fas fa-user\"></i></span>
                  <input type=\"email\" value=\"{{ last_username }}\" placeholder=\"Adresse e-mail\" name=\"_username\" id=\"username\" class=\"form-control\" autocomplete=\"email\" required autofocus />
                </div>
                <div class=\"input-group input-group-lg flex-nowrap\">
                  <span class=\"input-group-text\" id=\"mdp\"><i class=\"fas fa-key\"></i></span>
                  <input type=\"password\" placeholder=\"Mot de passe\" name=\"_password\" id=\"password\" class=\"form-control\" autocomplete=\"current-password\" required />
                ...
                <hr class=\"mt-4\" />
                <div class=\"w-100 text-end\">
                  <a class=\"security-link\" href=\"{{ path('app_forgot_password_request') }}\">Mot de passe oublié ?</a>
                </div>
                <div class=\"w-100 text-end\">
                  <button id=\"login-submit\" type=\"submit\" class=\"btn btn-lg btn-primary mt-3 w-100\">
                    Se connecter
...
", "security/login.html.twig", "D:\\PROJECTS\\Php\\erecrutement\\templates\\security\\login.html.twig");
    }
}

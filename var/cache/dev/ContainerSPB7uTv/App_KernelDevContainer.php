...
class App_KernelDevContainer extends Container
{
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\Back\\BackController', 'App\\Controller\\Back\\CandidateController', 'App\\Controller\\Back\\CertificationController', 'App\\Controller\\Back\\CivilityController', 'App\\Controller\\Back\\DegreeController', 'App\\Controller\\Back\\EducationController', 'App\\Controller\\Back\\FieldOfStudyController', 'App\\Controller\\Back\\InternshipController', 'App\\Controller\\Back\\LevelController', 'App\\Controller\\Back\\MaritalStatusController', 'App\\Controller\\Back\\PositionController', 'App\\Controller\\Back\\SkillController', 'App\\Controller\\Back\\StateController', 'App\\Controller\\Back\\UserController', 'App\\Controller\\Back\\WorkExperienceController', 'App\\Controller\\Front\\CertificationController', 'App\\Controller\\Front\\DocumentController', 'App\\Controller\\Front\\EducationController', 'App\\Controller\\Front\\EngagementController', 'App\\Controller\\Front\\FrontController', 'App\\Controller\\Front\\InternshipController', 'App\\Controller\\Front\\JobApplicationController', 'App\\Controller\\Front\\OtherInfoController', 'App\\Controller\\Front\\ProfileController', 'App\\Controller\\Front\\WorkExperienceController', 'App\\Controller\\PdfController', 'App\\Controller\\SecurityController', 'App\\Controller\\UserController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('G5dEbOGnpv', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('C6lH0MGHfs', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getTwigService($container)
    {
        ...
        $f->setDebug(false);
        $f->setTokenStorage(($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)));

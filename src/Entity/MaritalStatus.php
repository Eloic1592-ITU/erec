...
#[ORM\Table(name: '`EREC_MARITAL_STATUS`')]
class MaritalStatus
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\OneToMany(targetEntity: Profile::class, mappedBy: 'marital_status')]
    ...
    public function removeProfile(Profile $profile): static
    {
        if ($this->profiles->removeElement($profile)) {
            ...
            if ($profile->getMaritalStatus() === $this) {

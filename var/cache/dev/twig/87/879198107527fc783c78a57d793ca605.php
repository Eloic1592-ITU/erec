...
class __TwigTemplate_e37c94d58b1542b49a0f90666357c30d extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "back/partials/tables/civility/_index.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "back/partials/tables/civility/_index.html.twig"));
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["civilities"]) || array_key_exists("civilities", $context) ? $context["civilities"] : (function () { throw new RuntimeError('Variable "civilities" does not exist.', 12, $this->source); })()));
...
";
        // line 63
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["civilityForms"]) || array_key_exists("civilityForms", $context) ? $context["civilityForms"] : (function () { throw new RuntimeError('Variable "civilityForms" does not exist.', 63, $this->source); })()));
        $context['loop'] = [
...
";
    ...
    {% for civility in civilities %}
        <tr>
            <td>{{ civility.getId() }}</td>
            <td>{{ civility.getName() }}</td>
            <td>
                {% if not civility.isDeleted() %}
            ...
            <td>
                <div class=\"d-flex justify-content-end gap-1\">
                    <button 
                        class=\"btn-action bg-warning\" 
                        data-bs-toggle=\"modal\" 
                        data-bs-target=\"#civility-{{ civility.getId() }}\"
                    >
                        <i class=\"bx bx-edit\"></i> 
                        <span>Modifier</span>
                    </button>
                    ...
                    {% if not civility.isDeleted() %}
                        <button 
                            class=\"btn-action btn-state bg-danger delete-civility\"
                            data-state=\"désactiver cette civilité\" 
                            data-url=\"{{ path('admin_civility_disable', {'id': civility.getId()}) }}\"
                        >
                            <span>Désactiver</span>
                        </button>
                    {% else %}
                        <button 
                            class=\"btn-action btn-state bg-success delete-civility\"
                            data-state=\"réactiver cette civilité\" 
                            data-url=\"{{ path('admin_civility_activate', {'id': civility.getId()}) }}\"
                        >
                            <span>Activer</span>
                        </button>
                    {% endif %}
...
{{ include('back/partials/modals/_newCivility.html.twig') }}

{# Modals for Editing each items #}
{% for civilityForm in civilityForms %}
    {{ include('back/partials/modals/_editCivility.html.twig') }}
{% endfor %}", "back/partials/tables/civility/_index.html.twig", "/var/www/html/erecrutement/templates/back/partials/tables/civility/_index.html.twig");
    }
}
